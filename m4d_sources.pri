...
M4D_METRIC_SOURCES = $$M4D_SRC_DIR/metric/m4dMetric.cpp \
        ...
        $$M4D_SRC_DIR/metric/m4dMetricList.cpp
...
#  Further metrics
#
#CONFIG += use_all_metrics

use_all_metrics {
    DEFINES += ALL_METRICS_AVAILABLE
    M4D_METRIC_HEADERS += \
            ...
            $$M4D_SRC_DIR/metric/m4dMetricVaidyaIncRad.h
    ...
    M4D_METRIC_SOURCES +=  \
            ...
            $$M4D_SRC_DIR/metric/m4dMetricVaidyaIncRad.cpp
} # use_all_metric
