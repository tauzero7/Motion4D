/**
 * @file    m4dMetricExtremeReissnerNordstromDihole.h
 ...
 * @brief  Extreme Reissner-Nordstrom Dihole in Cartesian coordinates (t,x,y,z).
     ...
     where \f$U=1+\frac{M_1}{r_1}+\frac{M_2}{r_2}\f$, \f$r_1=\sqrt{x^2+y^2+(z-1)^2}\f$, and
 \f$r_2=\sqrt{x^2+y^2+(z+1)^2}\f$.

     The metric is taken from<br>
     S. Chandrasekhar,<br>
     <b>The two-centre problem in general relativity: the scattering of radiation by two extreme Reissner-Nordstrom
 black-holes,</b><br> Proc. R. Soc. Lond. A <b>421</b>, 227-258 (1989).
...
public:
    ...
    bool calcVelocityToEquilibriumPoint(
    ...
    bool calcHeightOfOtherPhotonOrbitsForUnequalMasses(
...
protected:
    ...
    void calc_ddU(const double y[], double& Uxx, double& Uyy, double& Uzz, double& Uxy, double& Uxz, double& Uyz);
