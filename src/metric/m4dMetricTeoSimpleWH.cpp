...
bool MetricTeoSimpleWH::calculateChristoffels(const double* pos)
{
    ...
    /*
        ...
        christoffel[0][0][2] = -0.25*b0h4*ch2*invr3*st*ct;
        christoffel[0][0][3] = 0;
        christoffel[0][1][0] = -1.0L/2.0L*b0h2*ch3*(-0.5*b0h2 - 0.5*l2)*t1*(0.25*b0h4*st2 -
       r2)*(-3.0*b0h2*c*l*(-0.5*b0h2 - 0.5*l2)*t3*st2 - 1.0*b0h2*c*l*t4*st2)*st4/((0.25*b0h4*ch2*t5*st2 -
       ch2)*(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 - r2)*st2))
       - 1.0*b0h4*ch2*l*invr3*((1.0L/2.0L)*b0h4*ch4*t6*t5*(0.25*b0h4*st2 - r2)*st4/(pow(0.25*b0h4*ch2*t5*st2 - ch2,
       2)*(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 - r2)*st2)) + (1.0L/2.0L)/(0.25*b0h4*ch2*t5*st2 - ch2))*st2;
        christoffel[0][1][1] = 0;
        christoffel[0][1][2] = 0;
        christoffel[0][1][3] = 0.5*b0h6*ch5*l*(-0.5*b0h2 - 0.5*l2)*t2*(0.25*b0h4*st2 - r2)*st4/((0.25*b0h4*ch2*t5*st2 -
       ch2)*(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 - r2)*st2)) + (1.0L/2.0L)*ch2*pow(b0h2 +
       l2, 1.0)*(0.25*b0h4*st2 - r2)*(-3.0*b0h2*c*l*(-0.5*b0h2 - 0.5*l2)*t3*st2
       - 1.0*b0h2*c*l*t4*st2)/(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 - r2)*st2); christoffel[0][2][0] =
       0.5*b0h4*ch2*t5*((1.0L/2.0L)*b0h4*ch4*t6*t5*(0.25*b0h4*st2 - r2)*st4/(pow(0.25*b0h4*ch2*t5*st2 - ch2,
       2)*(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 - r2)*st2)) + (1.0L/2.0L)/(0.25*b0h4*ch2*t5*st2 - ch2))*st*ct
       - 1.0*b0h4*ch4*t6*t5*(0.25*b0h4*st2 - r2)*st3*ct/((0.25*b0h4*ch2*t5*st2 - ch2)*(-0.25*b0h4*c2*r2*st4 +
       ch2*r2*(0.25*b0h4*st2 - r2)*st2)); christoffel[0][2][1] = 0; christoffel[0][2][2] = 0; christoffel[0][2][3]
       = 1.0*b0h2*ch3*(-0.5*b0h2 - 0.5*l2)*t1*(0.25*b0h4*st2 - r2)*st*ct/(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 -
       r2)*st2) - 0.25*b0h6*ch5*(-0.5*b0h2 - 0.5*l2)*t3*(0.25*b0h4*st2 - r2)*st3*ct/((0.25*b0h4*ch2*t5*st2 -
       ch2)*(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 - r2)*st2)); christoffel[0][3][0] = 0; christoffel[0][3][1]
       = 1.5*b0h2*c*l*(-0.5*b0h2 - 0.5*l2)*t3*st4 + 0.5*b0h2*c*l*t4*st4; christoffel[0][3][2] = -b0h2*c*(-0.5*b0h2 -
       0.5*l2)*t3*st*ct; christoffel[0][3][3] = 0; christoffel[1][0][0] = -1.0L/2.0L*b0h2*ch3*(-0.5*b0h2 -
       0.5*l2)*t1*(0.25*b0h4*st2 - r2)*(-3.0*b0h2*c*l*(-0.5*b0h2 - 0.5*l2)*t3*st2
       - 1.0*b0h2*c*l*t4*st2)*st4/((0.25*b0h4*ch2*t5*st2 - ch2)*(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 -
       r2)*st2)) - 1.0*b0h4*ch2*l*invr3*((1.0L/2.0L)*b0h4*ch4*t6*t5*(0.25*b0h4*st2 - r2)*st4/(pow(0.25*b0h4*ch2*t5*st2 -
       ch2, 2)*(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 - r2)*st2)) + (1.0L/2.0L)/(0.25*b0h4*ch2*t5*st2 -
       ch2))*st2; christoffel[1][0][1] = 0; christoffel[1][0][2] = 0; christoffel[1][0][3] = 0.5*b0h6*ch5*l*(-0.5*b0h2 -
       0.5*l2)*t2*(0.25*b0h4*st2 - r2)*st4/((0.25*b0h4*ch2*t5*st2 - ch2)*(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 -
       r2)*st2)) + (1.0L/2.0L)*ch2*pow(b0h2 + l2, 1.0)*(0.25*b0h4*st2 - r2)*(-3.0*b0h2*c*l*(-0.5*b0h2 - 0.5*l2)*t3*st2
       - 1.0*b0h2*c*l*t4*st2)/(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 - r2)*st2); christoffel[1][1][0] = 0;
        christoffel[1][1][1] = 0;
        christoffel[1][1][2] = 0;
        christoffel[1][1][3] = 0;
        christoffel[1][2][0] = 0;
        ...
        christoffel[1][2][2] = 1.0*l/(b0h2 + l2);
        christoffel[1][2][3] = 0;
        christoffel[1][3][0] = -1.0*b0h2*ch3*l*(-0.5*b0h2 - 0.5*l2)*t1*(0.25*b0h4*st2 - r2)*st4/((0.25*b0h4*ch2*t5*st2 -
       ch2)*(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 - r2)*st2)) + (-3.0*b0h2*c*l*(-0.5*b0h2 - 0.5*l2)*t3*st4
       - 1.0*b0h2*c*l*t4*st4)*((1.0L/2.0L)*b0h4*ch4*t6*t5*(0.25*b0h4*st2 - r2)*st4/(pow(0.25*b0h4*ch2*t5*st2 - ch2,
       2)*(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 - r2)*st2)) + (1.0L/2.0L)/(0.25*b0h4*ch2*t5*st2 - ch2));
        christoffel[1][3][1] = 0;
        christoffel[1][3][2] = 0;
        christoffel[1][3][3] = -1.0L/2.0L*b0h2*ch3*(-0.5*b0h2 - 0.5*l2)*t1*(0.25*b0h4*st2 -
       r2)*(-3.0*b0h2*c*l*(-0.5*b0h2 - 0.5*l2)*t3*st4 - 1.0*b0h2*c*l*t4*st4)*st2/((0.25*b0h4*ch2*t5*st2 -
       ch2)*(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 - r2)*st2)) + 1.0*ch2*l*pow(b0h2 + l2, 1.0)*(0.25*b0h4*st2 -
       r2)*st2/(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 - r2)*st2); christoffel[2][0][0] =
       0.5*b0h4*ch2*t5*((1.0L/2.0L)*b0h4*ch4*t6*t5*(0.25*b0h4*st2 - r2)*st4/(pow(0.25*b0h4*ch2*t5*st2 - ch2,
       2)*(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 - r2)*st2)) + (1.0L/2.0L)/(0.25*b0h4*ch2*t5*st2 - ch2))*st*ct
       - 1.0*b0h4*ch4*t6*t5*(0.25*b0h4*st2 - r2)*st3*ct/((0.25*b0h4*ch2*t5*st2 - ch2)*(-0.25*b0h4*c2*r2*st4 +
       ch2*r2*(0.25*b0h4*st2 - r2)*st2)); christoffel[2][0][1] = 0; christoffel[2][0][2] = 0; christoffel[2][0][3]
       = 1.0*b0h2*ch3*(-0.5*b0h2 - 0.5*l2)*t1*(0.25*b0h4*st2 - r2)*st*ct/(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 -
       r2)*st2) - 0.25*b0h6*ch5*(-0.5*b0h2 - 0.5*l2)*t3*(0.25*b0h4*st2 - r2)*st3*ct/((0.25*b0h4*ch2*t5*st2 -
       ch2)*(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 - r2)*st2)); christoffel[2][1][0] = 0; christoffel[2][1][1] =
       0; christoffel[2][1][2] = 1.0*l/(b0h2 + l2); christoffel[2][1][3] = 0; christoffel[2][2][0] = 0;
        christoffel[2][2][1] = -1.0*l;
        christoffel[2][2][2] = 0;
        christoffel[2][2][3] = 0;
        christoffel[2][3][0] = 2*b0h2*c*(-0.5*b0h2 - 0.5*l2)*t4*((1.0L/2.0L)*b0h4*ch4*t6*t5*(0.25*b0h4*st2 -
       r2)*st4/(pow(0.25*b0h4*ch2*t5*st2 - ch2, 2)*(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 - r2)*st2)) +
       (1.0L/2.0L)/(0.25*b0h4*ch2*t5*st2 - ch2))*st*ct - 1.0*b0h2*ch3*(-0.5*b0h2 - 0.5*l2)*sqrt(b0h2 +
       l2)*(0.25*b0h4*st2 - r2)*st3*ct/((0.25*b0h4*ch2*t5*st2 - ch2)*(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 -
       r2)*st2)); christoffel[2][3][1] = 0; christoffel[2][3][2] = 0; christoffel[2][3][3] =
       -b0h4*ch4*t6*t5*(0.25*b0h4*st2 - r2)*st3*ct/((0.25*b0h4*ch2*t5*st2 - ch2)*(-0.25*b0h4*c2*r2*st4 +
       ch2*r2*(0.25*b0h4*st2 - r2)*st2)) + 1.0*ch2*r2*(0.25*b0h4*st2 - r2)*st*ct/(-0.25*b0h4*c2*r2*st4 +
       ch2*r2*(0.25*b0h4*st2 - r2)*st2); christoffel[3][0][0] = 0; christoffel[3][0][1] = 1.5*b0h2*c*l*(-0.5*b0h2 -
       0.5*l2)*t3*st2 + 0.5*b0h2*c*l*t4*st2; christoffel[3][0][2] = -1.0*b0h2*c*(-0.5*b0h2 - 0.5*l2)*t3*st*ct;
        christoffel[3][0][3] = 0;
        christoffel[3][1][0] = -1.0*b0h2*ch3*l*(-0.5*b0h2 - 0.5*l2)*t1*(0.25*b0h4*st2 - r2)*st4/((0.25*b0h4*ch2*t5*st2 -
       ch2)*(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 - r2)*st2)) + (-3.0*b0h2*c*l*(-0.5*b0h2 - 0.5*l2)*t3*st4
       - 1.0*b0h2*c*l*t4*st4)*((1.0L/2.0L)*b0h4*ch4*t6*t5*(0.25*b0h4*st2 - r2)*st4/(pow(0.25*b0h4*ch2*t5*st2 - ch2,
       2)*(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 - r2)*st2)) + (1.0L/2.0L)/(0.25*b0h4*ch2*t5*st2 - ch2));
        christoffel[3][1][1] = 0;
        christoffel[3][1][2] = 0;
        christoffel[3][1][3] = -1.0L/2.0L*b0h2*ch3*(-0.5*b0h2 - 0.5*l2)*t1*(0.25*b0h4*st2 -
       r2)*(-3.0*b0h2*c*l*(-0.5*b0h2 - 0.5*l2)*t3*st4 - 1.0*b0h2*c*l*t4*st4)*st2/((0.25*b0h4*ch2*t5*st2 -
       ch2)*(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 - r2)*st2)) + 1.0*ch2*l*pow(b0h2 + l2, 1.0)*(0.25*b0h4*st2 -
       r2)*st2/(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 - r2)*st2); christoffel[3][2][0] = 2*b0h2*c*(-0.5*b0h2 -
       0.5*l2)*t4*((1.0L/2.0L)*b0h4*ch4*t6*t5*(0.25*b0h4*st2 - r2)*st4/(pow(0.25*b0h4*ch2*t5*st2 - ch2,
       2)*(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 - r2)*st2)) + (1.0L/2.0L)/(0.25*b0h4*ch2*t5*st2 - ch2))*st*ct
       - 1.0*b0h2*ch3*(-0.5*b0h2 - 0.5*l2)*sqrt(b0h2 + l2)*(0.25*b0h4*st2 - r2)*st3*ct/((0.25*b0h4*ch2*t5*st2 -
       ch2)*(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 - r2)*st2)); christoffel[3][2][1] = 0; christoffel[3][2][2] =
       0; christoffel[3][2][3] = -b0h4*ch4*t6*t5*(0.25*b0h4*st2 - r2)*st3*ct/((0.25*b0h4*ch2*t5*st2 -
       ch2)*(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 - r2)*st2)) + 1.0*ch2*r2*(0.25*b0h4*st2 -
       r2)*st*ct/(-0.25*b0h4*c2*r2*st4 + ch2*r2*(0.25*b0h4*st2 - r2)*st2); christoffel[3][3][0] = 0;
        christoffel[3][3][1] = -1.0*l*st2;
        christoffel[3][3][2] = -1.0*st*ct;
        christoffel[3][3][3] = 0;
    */
