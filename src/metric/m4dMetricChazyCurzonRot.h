/**
 * @file    m4dMetricChazyCurzonRot.h
 ...
 * @brief  ChazyCurzonRot metric in Weyl coordinates (t,rho,phi,z).
     ...
     \f[ds^2 =
 e^{-2U}\left[e^{2k}\left(d\rho^2+dz^2\right)+\rho^2d\varphi^2\right]-e^{2U}\left(dt+A\,d\varphi\right)^2,\f] where
 \f$e^{-2U}=\cosh\frac{2m}{r}-p\sinh\frac{2m}{r}\f$, \f$2k=-m^2\rho^2/r^4\f$, \f$A=2qmz/r\f$, and \f$r^2=\rho^2+z^2\f$.
