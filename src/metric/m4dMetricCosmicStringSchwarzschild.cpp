 ...
 */
bool MetricCosmicStringSchwarzschild::setParam(std::string pName, double val) {
 ...
 */
bool MetricCosmicStringSchwarzschild::setEmbeddingParam(std::string name, double val) {
