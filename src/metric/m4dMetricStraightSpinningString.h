/**
 * @file    m4dMetricStraightSpinningString.h
 ...
 * @brief  StraightSpinningString metric in cylindrical coordinates (t,rho,phi,z).
     ...
     \f[ \mathbf{e}_{(0)} = \frac{1}{c}\partial_t,\quad \mathbf{e}_{(1)} = \partial_{\rho},\quad \mathbf{e}_{(2)} =
 \frac{1}{k\rho}\left(\frac{a}{c}\partial_t+\partial_{\varphi}\right),\quad \mathbf{e}_{(3)} = \partial_z. \f]
     ...
     with constants of motion \f$h_1=c(c\dot{t}-a\dot{\varphi})\f$ and
 \f$h_2=a(c\dot{t}-a\dot{\varphi})+k^2\rho^2\dot{\varphi}\f$.
