 ...
 */
void MetricChazyCurzonRot::localToCoord(const double* pos, const double* ldir, double* dir,
 ...
 */
void MetricChazyCurzonRot::coordToLocal(const double* , const double* , double* ,
 ...
 */
bool MetricChazyCurzonRot::setParam(std::string pName, double val) {
...
/*! Generate report.
 */
bool MetricChazyCurzonRot::report(const vec4 , const vec4 , std::string &text) {
    std::stringstream ss;
...
/*!
 */
void MetricChazyCurzonRot::calcDUka(const double* pos, double &dUdrho, double &dUdz,
