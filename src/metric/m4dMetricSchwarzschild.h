 ...
 * @brief  Schwarzschild metric in spherical coordinates (t,r,theta,phi).
 ...
 \mathbf{e}_{(3)} = \frac{1}{r\sin\vartheta}\partial_{\varphi}.\f]
     ...
     \f[ \frac{1}{2}\dot{r}^2+V_{\mbox{eff}} = \frac{1}{2}\frac{k^2}{c^2},\qquad\mbox{with}\qquad
 V_{\mbox{eff}}=\frac{1}{2}\left(\frac{h^2}{r^2}-\kappa c^2\right)\left(1-\frac{r_s}{r}\right)\f] and the constants of
 motion \f$k=(1-r_s/r)c^2\dot{t}\f$ and \f$h=r^2\dot{\varphi}\f$.
...
/**
 * @brief The MetricSchwarzschild class
 */
...
public:
    ...
    void param_sq(const double k, const double h, const int kappa, double& p, double& q, double& D1);
