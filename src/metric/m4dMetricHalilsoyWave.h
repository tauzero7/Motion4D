 ...
 * @brief  Gravitational wave solution given by Halilsoy.
       ...
       \f[ ds^2 = e^{-2U}\left[e^{2k}\left(d\rho^2-dt^2\right) + \rho^2d\varphi^2\right] +
 e^{2U}\left(dz+A\,d\varphi\right)^2,\f] where \f$e^{-2U}=\cosh^2\alpha\,e^{-2CJ_0(\rho)\cos
 t}+\sinh^2\alpha\,e^{2CJ_0(\rho)\cos t}\f$, \f$A=-2C\sinh(2\alpha)\rho J_1(\rho)\sin t\f$,
       \f$k=\frac{1}{2}C^2\left[\rho^2\left(J_o(\rho)^2+J_1(\rho)^2\right)-2\rho J_0(\rho)J_1(\rho)\cos^2t\right]\f$,
 and the Bessel functions J_i.
