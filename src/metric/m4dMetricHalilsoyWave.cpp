 ...
 */
void MetricHalilsoyWave::localToCoord(const double* pos, const double* ldir, double* dir,
 ...
 *  \param  type :  type of tetrad.
 */
void MetricHalilsoyWave::coordToLocal(const double* pos, const double* cdir, double* ldir,
                                      enum_nat_tetrad_type) {
    double rho = pos[1];
    calcMetricFunc(pos);
...
/*! Generate report.
 */
bool MetricHalilsoyWave::report(const vec4, const vec4, std::string &text) {
    std::stringstream ss;
