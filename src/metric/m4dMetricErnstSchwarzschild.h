...
/*!  \class  m4d::MetricErnstSchwarzschild
     \brief  Ernst-Schwarzschild metric in spherical coordinates (t,r,theta,phi).
             ...
             Detailed discussions about the Ernst-Schwarzschild metric can be found in
             <ul>
...
#ifndef M4D_METRIC_ERNST_SCHWARZSCHILD_H
#define M4D_METRIC_ERNST_SCHWARZSCHILD_H
...
// ---------------------------------------------------
//    class definition:   MetricErnstSchwarzschild
// ---------------------------------------------------
class MetricErnstSchwarzschild : public Metric {
public:
    MetricErnstSchwarzschild(double mass = 1.0, double B = 0.1);
    virtual ~MetricErnstSchwarzschild();
