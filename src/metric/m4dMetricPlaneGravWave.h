 ...
 * @brief  Metric for a plane gravitational wave with finite logitudinal and
     ...
     \f[ m\left(u\right) = \pm2\sqrt{3} \int \sqrt{\frac{u^{2} + au}{2a^{3}u - 2au^{3} - u^{4} - 2a^{3}}} \, \mathrm{d}
 u.\f]

     The natural local tetrad is given by
     \f[ \mathbf{e}_{(0)} = \frac{1}{c}\partial_t,\quad \mathbf{e}_{(1)}=\partial_x,\quad \mathbf{e}_{(2)}=
 \frac{1}{p\left(u\right)}\partial_y,\quad \mathbf{e}_{(3)} = \frac{1}{p\left(u\right)}\partial_z.\f]
