 ...
 */
void MetricVaidyaIncRad::localToCoord(const double* pos, const double* ldir, double* dir,
 ...
 *  \param  type :  type of tetrad.
 */
void MetricVaidyaIncRad::coordToLocal(const double* pos, const double* cdir, double* ldir,
                                enum_nat_tetrad_type) {
...
/*! Generate report.
 */
bool MetricVaidyaIncRad::report(const vec4 , const vec4 , std::string &text) {
    std::stringstream ss;
