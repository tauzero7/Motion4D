...
bool MetricKerrBL::calculateChristoffels(const double* pos)
{
    ...
    christoffel[3][3][2] = -t62
        * (t36 * t1 + 2.0 * t126 * t7 + t129 * t87 + t126 + 2.0 * t129 * t7 + t28 * t4 * t87 + 4.0 * t38 * t4
            - 4.0 * t38 * t8 - 2.0 * t2 * t113 + 2.0 * t89 * r)
        * t12;
...
bool MetricKerrBL::calculateChrisD(const double* pos)
{
    ...
    double t208 = t101 * t4;
    double t214 = -8.0 * t193 * t20 + 4.0 * t196 - t68 + 2.0 * t192 * t2 + t71 + t66 - t200 - t202 + 3.0 * t85
        + 2.0 * t204 + 8.0 * t206 - 4.0 * t208 - 2.0 * m * t3 - 2.0 * t170 * t192;
    double t215 = t36 * t36;
    double t216 = 1 / t215;
    ...
    double t291 = t268 - t270 - t272 + t274 + 3.0 * t276 + t279 - 6.0 * t280 - 3.0 * t283 + 6.0 * t285 - 8.0 * t287
        + 12.0 * t289;
    double t292 = t77 * t74;
    ...
    double t309 = t2 * t2;
    double t314
        = -t293 + 3.0 * t294 + t297 - 3.0 * t299 + t303 + t298 - t306 + t308 - t309 + 4.0 * t91 * m - 4.0 * t192 * t89;
    ...
    double t348 = t15 * t9;
    double t351 = r * t267;
    double t361 = (4.0 * t348 * t47 - 4.0 * t13 * t351 + 10.0 * t204 - 6.0 * t206 + 2.0 * t208 + t202 + t89 + 3.0 * t200
                      - 6.0 * t196 + t269)
        * t139 * t161;
    double t362 = t82 * t74;
    double t364 = t66 * t34;
    ...
    double t376
        = 2.0 * t307 + t371 + t272 + t268 - t279 - 16.0 * t287 + 16.0 * t289 + t303 - 6.0 * t273 - 8.0 * t280 - t298;
    double t393 = t82 + t91 + t243 + t77 * t9 + 2.0 * t80 - 4.0 * t73 - 2.0 * t67 + 2.0 * t83 + 8.0 * t75 + 2.0 * t78
        - 2.0 * t86 + 2.0 * t68 * m - 4.0 * t13 * t1;
    double t412 = t8 * t3 + 2.0 * t348 * t4 + t351 * t5 - t3 - 2.0 * t17 - t10 - 6.0 * t11 + t122 + 6.0 * t74 * t2
        - t72 * t96 - t267 * t5 * m - 5.0 * t47 * t1 + t13 * t8;
    double t438 = 24.0 * t292 - 18.0 * t285 + 4.0 * t9 * t89 * t4 + t299 + 5.0 * t283 + t371 + 2.0 * t267 * t2 * t5
        + t268 - t297 - t308 - t298;
    ...
    chrisD[3][3][1][0] = 0.0;
    chrisD[3][3][1][1] = t160
        * (t309 - t293 - 6.0 * t362 + 10.0 * t364 + t276 + 5.0 * t299 + 7.0 * t283 - t294 + 4.0 * t296 - t306 + t376)
        * t31;
    chrisD[3][3][1][2] = -2.0 * t36 * t7 * t39 * t393 * t31;
    chrisD[3][3][1][3] = 0.0;
    chrisD[3][3][2][0] = 0.0;
    chrisD[3][3][2][1] = -2.0 * t40 * t4 * t412 * t31;
    chrisD[3][3][2][2] = -(-t309 + 2.0 * t8 * t309 - t274 + 10.0 * t280 - t294 + t276 - 16.0 * t9 * t3 * t47
                             - 4.0 * t267 * t15 * t13 + 20.0 * t362 - 8.0 * t364 + t438)
        * t31;
    chrisD[3][3][2][3] = 0.0;
    chrisD[3][3][3][0] = 0.0;
    chrisD[3][3][3][1] = 0.0;
...
void MetricKerrBL::localToCoord(const double* pos, const double* ldir, double* dir, enum_nat_tetrad_type type)
{
    double r = pos[1];
    double theta = pos[2];
...
void MetricKerrBL::coordToLocal(const double* pos, const double* cdir, double* ldir, enum_nat_tetrad_type type)
{
    double r = pos[1];
    double theta = pos[2];
...
bool MetricKerrBL::calcDerivs(const double y[], double dydx[])
{
    ...
    dydx[4] = -2.0 * G_t_r_t * y[4] * y[5] - 2.0 * G_t_th_t * y[4] * y[6] - 2.0 * G_r_ph_t * y[5] * y[7]
        - 2.0 * G_th_ph_t * y[6] * y[7];
    dydx[5] = -G_t_t_r * y[4] * y[4] - 2.0 * G_t_ph_r * y[4] * y[7] - G_r_r_r * y[5] * y[5]
        - 2.0 * G_r_th_r * y[5] * y[6] - G_ph_ph_r * y[7] * y[7] - G_th_th_r * y[6] * y[6];
    dydx[6] = -G_ph_ph_th * y[7] * y[7] - G_t_t_th * y[4] * y[4] - 2.0 * G_t_ph_th * y[4] * y[7]
        - G_r_r_th * y[5] * y[5] - 2.0 * G_r_th_th * y[5] * y[6] - G_th_th_th * y[6] * y[6];
    dydx[7] = -2.0 * G_r_ph_ph * y[5] * y[7] - 2.0 * G_th_ph_ph * y[6] * y[7] - 2.0 * G_t_r_ph * y[4] * y[5]
        - 2.0 * G_t_th_ph * y[4] * y[6];
...
double MetricKerrBL::testConstraint(const double y[], const double kappa)
{
    ...
    double sum = -kappa;
    sum += -(1.0 - 2.0 * mass * r / sigma) * y[4] * y[4] - 4.0 * mass * angmom * r * st2 / sigma * y[4] * y[7]
        + sigma / delta * y[5] * y[5] + sigma * y[6] * y[6]
        + (r * r + angmom * angmom + 2.0 * mass * angmom * angmom * r * st2 / sigma) * st2 * y[7] * y[7];
    return sum;
}
...
bool MetricKerrBL::effPotentialValue(
    const vec4 pos, const vec4 cdir, enum_geodesic_type type, const double x, double& val)
{
    ...
    double h = (pos[1] * pos[1] + angmom * angmom + rs * angmom * angmom / pos[1]) * cdir[3]
        - rs * angmom / pos[1] * cdir[0];
    // fprintf(stderr,"%f %f  %f %f\n",cdir[0],cdir[3],k,h);
    val = 0.5 * pow(x, -3.0)
            * (h * h * (x - rs) + 2.0 * angmom * h * k * rs - k * k * (x * x * x + angmom * angmom * (x + rs)))
        - 0.5 * kappa * (x * x - rs * x + angmom * angmom) / (x * x);
    return true;
}
...
double MetricKerrBL::getCircularVelocity(const double r, const enum_nat_tetrad_type)
{
    ...
    double beta = (rs * a * pow(r, 4.0) * (3.0 * r * r + a2) - A * sqrt(2.0 * pow(r, 7.0) * rs))
        / (r * r * sqrt(delta) * (-2.0 * pow(r, 5.0) + rs * a2 * r * r));
    return beta;
}
...
void MetricKerrBL::getCircularVelocities(const double r, double& b1, double& b2)
{
    ...
    b1 = (rs * a * pow(r, 4.0) * (3.0 * r * r + a2) - A * sqrt(2.0 * pow(r, 7.0) * rs))
        / (r * r * sqrt(delta) * (-2.0 * pow(r, 5.0) + rs * a2 * r * r));
    b2 = (rs * a * pow(r, 4.0) * (3.0 * r * r + a2) + A * sqrt(2.0 * pow(r, 7.0) * rs))
        / (r * r * sqrt(delta) * (-2.0 * pow(r, 5.0) + rs * a2 * r * r));
}

vec4 MetricKerrBL::getCircularFourVel(const vec4 pos, const enum_nat_tetrad_type)
{
...
bool MetricKerrBL::report(const vec4 pos, const vec4 cdir, char*& text)
{
    std::stringstream ss;
...
bool MetricKerrBL::calcMSOvelocities(double& velDirect, double& velRetrograd)
{
    ...
    double ut = (rD * sqrt(rD) + angmom * sqrt(mass)) / sqrt(rD)
        / sqrt(rD * rD - 3.0 * mass * rD + 2.0 * angmom * sqrt(mass) * sqrt(rD));
    double dt = sqrt(((rD * rD + angmom * angmom) * rD * rD + 2.0 * mass * angmom * angmom * rD)
        / (rD * rD * (rD * rD - 2.0 * mass * rD + angmom * angmom)));
    double g = ut / dt;
...
{
    double st2 = sin(theta) * sin(theta);
    double ginv2 = 1.0 - 2.0 * mass * r / sigma + 4.0 * mass * angmom * r * st2 / sigma * zeta
        - (r * r + angmom * angmom + 2.0 * mass * angmom * angmom * r * st2 / sigma) * st2 * zeta * zeta;
    ga = 1.0 / sqrt(ginv2);
    return true;
}
