...
bool MetricSchwarzschildCartNew::calculateChristoffels(const double* pos)
{
    ...
    double GDenominator
        = gxx * gyy * gzz + REAL_TWO * gxy * gxz * gyz - gxx * gyzSquare - gxySquare * gzz - gxzSquare * gyy;
    ...
    double G_t_t_x = -REAL_HALF
        * (gttDx * gyy * gzz - gttDx * gyzSquare + gttDy * gxz * gyz - gttDy * gxy * gzz + gttDz * gxy * gyz
            - gttDz * gxz * gyy)
        / GDenominator;
    christoffel[0][0][1] = G_t_t_x;

    double G_x_x_x = REAL_HALF
        * (gxxDx * gyy * gzz - gxxDx * gyzSquare + REAL_TWO * gxz * gyz * gxyDx - gxz * gyz * gxxDy
            - REAL_TWO * gxy * gzz * gxyDx + gxy * gzz * gxxDy + REAL_TWO * gxy * gyz * gxzDx - gxy * gyz * gxxDz
            - REAL_TWO * gxz * gyy * gxzDx + gxz * gyy * gxxDz)
        / GDenominator;
    christoffel[1][1][1] = G_x_x_x;

    double G_x_y_x = -REAL_HALF
        * (-gxxDy * gyy * gzz + gxxDy * gyzSquare - gyyDx * gxz * gyz + gyyDx * gxy * gzz - gxy * gyz * gxzDy
            - gxy * gyz * gyzDx + gxy * gyz * gxyDz + gxz * gyy * gxzDy + gxz * gyy * gyzDx - gxz * gyy * gxyDz)
        / GDenominator;
    christoffel[1][2][1] = G_x_y_x;
    christoffel[2][1][1] = G_x_y_x;

    double G_x_z_x = REAL_HALF
        * (gxxDz * gyy * gzz - gxxDz * gyzSquare + gxz * gyz * gxyDz + gxz * gyz * gyzDx - gxz * gyz * gxzDy
            - gxy * gzz * gxyDz - gxy * gzz * gyzDx + gxy * gzz * gxzDy + gzzDx * gxy * gyz - gzzDx * gxz * gyy)
        / GDenominator;
    christoffel[1][3][1] = G_x_z_x;
    christoffel[3][1][1] = G_x_z_x;

    double G_y_y_x = -REAL_HALF
        * (-REAL_TWO * gyy * gzz * gxyDy + gyy * gzz * gyyDx + REAL_TWO * gyzSquare * gxyDy - gyzSquare * gyyDx
            - gyyDy * gxz * gyz + gyyDy * gxy * gzz - REAL_TWO * gxy * gyz * gyzDy + gxy * gyz * gyyDz
            + REAL_TWO * gxz * gyy * gyzDy - gxz * gyy * gyyDz)
        / GDenominator;
    christoffel[2][2][1] = G_y_y_x;

    double G_y_z_x = REAL_HALF
        * (gyy * gzz * gxyDz + gyy * gzz * gxzDy - gyy * gzz * gyzDx - gyzSquare * gxyDz - gyzSquare * gxzDy
            + gyzSquare * gyzDx + gyyDz * gxz * gyz - gyyDz * gxy * gzz + gzzDy * gxy * gyz - gzzDy * gxz * gyy)
        / GDenominator;
    christoffel[2][3][1] = G_y_z_x;
    christoffel[3][2][1] = G_y_z_x;

    double G_z_z_x = -REAL_HALF
        * (-REAL_TWO * gyy * gzz * gxzDz + gyy * gzz * gzzDx + REAL_TWO * gyzSquare * gxzDz - gyzSquare * gzzDx
            - REAL_TWO * gxz * gyz * gyzDz + gxz * gyz * gzzDy + REAL_TWO * gxy * gzz * gyzDz - gxy * gzz * gzzDy
            - gzzDz * gxy * gyz + gzzDz * gxz * gyy)
        / GDenominator;
    christoffel[3][3][1] = G_z_z_x;

    double G_t_t_y = REAL_HALF
        * (-gttDx * gxz * gyz + gttDx * gxy * gzz - gttDy * gxx * gzz + gttDy * gxzSquare - gttDz * gxy * gxz
            + gttDz * gxx * gyz)
        / GDenominator;
    christoffel[0][0][2] = G_t_t_y;

    double G_x_x_y = -REAL_HALF
        * (-gxxDx * gxz * gyz + gxxDx * gxy * gzz - REAL_TWO * gxx * gzz * gxyDx + gxx * gzz * gxxDy
            + REAL_TWO * gxzSquare * gxyDx - gxzSquare * gxxDy - REAL_TWO * gxy * gxz * gxzDx + gxy * gxz * gxxDz
            + REAL_TWO * gxx * gyz * gxzDx - gxx * gyz * gxxDz)
        / GDenominator;
    christoffel[1][1][2] = G_x_x_y;

    double G_x_y_y = REAL_HALF
        * (gxz * gyz * gxxDy - gxy * gzz * gxxDy + gyyDx * gxx * gzz - gyyDx * gxzSquare + gxy * gxz * gxzDy
            + gxy * gxz * gyzDx - gxy * gxz * gxyDz - gxx * gyz * gxzDy - gxx * gyz * gyzDx + gxx * gyz * gxyDz)
        / GDenominator;
    christoffel[1][2][2] = G_x_y_y;
    christoffel[2][1][2] = G_x_y_y;

    double G_x_z_y = -REAL_HALF
        * (-gxxDz * gxz * gyz + gxxDz * gxy * gzz - gxx * gzz * gxyDz - gxx * gzz * gyzDx + gxx * gzz * gxzDy
            + gxzSquare * gxyDz + gxzSquare * gyzDx - gxzSquare * gxzDy - gzzDx * gxy * gxz + gzzDx * gxx * gyz)
        / GDenominator;
    christoffel[1][3][2] = G_x_z_y;
    christoffel[3][1][2] = G_x_z_y;

    double G_y_y_y = REAL_HALF
        * (REAL_TWO * gxz * gyz * gxyDy - gyyDx * gxz * gyz - REAL_TWO * gxy * gzz * gxyDy + gyyDx * gxy * gzz
            + gyyDy * gxx * gzz - gyyDy * gxzSquare + REAL_TWO * gxy * gxz * gyzDy - gxy * gxz * gyyDz
            - REAL_TWO * gxx * gyz * gyzDy + gxx * gyz * gyyDz)
        / GDenominator;
    christoffel[2][2][2] = G_y_y_y;

    double G_y_z_y = -REAL_HALF
        * (-gxz * gyz * gxyDz - gxz * gyz * gxzDy + gxz * gyz * gyzDx + gxy * gzz * gxyDz + gxy * gzz * gxzDy
            - gxy * gzz * gyzDx - gyyDz * gxx * gzz + gyyDz * gxzSquare - gzzDy * gxy * gxz + gzzDy * gxx * gyz)
        / GDenominator;
    christoffel[2][3][2] = G_y_z_y;
    christoffel[3][2][2] = G_y_z_y;

    double G_z_z_y = REAL_HALF
        * (REAL_TWO * gxz * gyz * gxzDz - gxz * gyz * gzzDx - REAL_TWO * gxy * gzz * gxzDz + gxy * gzz * gzzDx
            + REAL_TWO * gxx * gzz * gyzDz - gxx * gzz * gzzDy - REAL_TWO * gxzSquare * gyzDz + gxzSquare * gzzDy
            + gzzDz * gxy * gxz - gzzDz * gxx * gyz)
        / GDenominator;
    christoffel[3][3][2] = G_z_z_y;

    double G_t_t_z = REAL_HALF
        * (-gttDx * gxy * gyz + gttDx * gxz * gyy - gttDy * gxy * gxz + gttDy * gxx * gyz - gttDz * gxx * gyy
            + gttDz * gxySquare)
        / GDenominator;
    christoffel[0][0][3] = G_t_t_z;

    double G_x_x_z = -REAL_HALF
        * (-gxxDx * gxy * gyz + gxxDx * gxz * gyy - REAL_TWO * gxy * gxz * gxyDx + gxy * gxz * gxxDy
            + REAL_TWO * gxx * gyz * gxyDx - gxx * gyz * gxxDy - REAL_TWO * gxx * gyy * gxzDx + gxx * gyy * gxxDz
            + REAL_TWO * gxySquare * gxzDx - gxySquare * gxxDz)
        / GDenominator;
    christoffel[1][1][3] = G_x_x_z;

    double G_x_y_z = -REAL_HALF
        * (-gxxDy * gxy * gyz + gxxDy * gxz * gyy - gyyDx * gxy * gxz + gyyDx * gxx * gyz - gxx * gyy * gxzDy
            - gxx * gyy * gyzDx + gxx * gyy * gxyDz + gxySquare * gxzDy + gxySquare * gyzDx - gxySquare * gxyDz)
        / GDenominator;
    christoffel[1][2][3] = G_x_y_z;
    christoffel[2][1][3] = G_x_y_z;

    double G_x_z_z = REAL_HALF
        * (gxy * gyz * gxxDz - gxz * gyy * gxxDz + gxy * gxz * gxyDz + gxy * gxz * gyzDx - gxy * gxz * gxzDy
            - gxx * gyz * gxyDz - gxx * gyz * gyzDx + gxx * gyz * gxzDy + gzzDx * gxx * gyy - gzzDx * gxySquare)
        / GDenominator;
    christoffel[1][3][3] = G_x_z_z;
    christoffel[3][1][3] = G_x_z_z;

    double G_y_y_z = REAL_HALF
        * (REAL_TWO * gxy * gyz * gxyDy - gxy * gyz * gyyDx - REAL_TWO * gxz * gyy * gxyDy + gxz * gyy * gyyDx
            + gyyDy * gxy * gxz - gyyDy * gxx * gyz + REAL_TWO * gxx * gyy * gyzDy - gxx * gyy * gyyDz
            - REAL_TWO * gxySquare * gyzDy + gxySquare * gyyDz)
        / GDenominator;
    christoffel[2][2][3] = G_y_y_z;

    double G_y_z_z = -REAL_HALF
        * (-gxy * gyz * gxyDz - gxy * gyz * gxzDy + gxy * gyz * gyzDx + gxz * gyy * gxyDz + gxz * gyy * gxzDy
            - gxz * gyy * gyzDx - gxy * gxz * gyyDz + gxx * gyz * gyyDz - gzzDy * gxx * gyy + gzzDy * gxySquare)
        / GDenominator;
    christoffel[2][3][3] = G_y_z_z;
    christoffel[3][2][3] = G_y_z_z;

    double G_z_z_z = REAL_HALF
        * (REAL_TWO * gxy * gyz * gxzDz - gzzDx * gxy * gyz - REAL_TWO * gxz * gyy * gxzDz + gzzDx * gxz * gyy
            + REAL_TWO * gxy * gxz * gyzDz - gzzDy * gxy * gxz - REAL_TWO * gxx * gyz * gyzDz + gzzDy * gxx * gyz
            + gzzDz * gxx * gyy - gzzDz * gxySquare)
        / GDenominator;
 ...
 */
void MetricSchwarzschildCartNew::localToCoord(const double* pos, const double* ldir, double* dir, enum_nat_tetrad_type)
{
    double x = pos[1];
    double y = pos[2];
    double z = pos[3];
 ...
 *  \param  type :  type of tetrad.
 */
void MetricSchwarzschildCartNew::coordToLocal(const double* pos, const double* cdir, double* ldir, enum_nat_tetrad_type)
{
    double x = pos[1];
    double y = pos[2];
    double z = pos[3];
...
/*! Generate report.
 */
bool MetricSchwarzschildCartNew::report(const vec4, const vec4, char*& text)
{
    std::stringstream ss;
