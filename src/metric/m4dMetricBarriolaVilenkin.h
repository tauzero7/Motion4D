/**
 * @file    m4dMetricBarriolaVilenkin.h
 ...
 * @brief  Barriola-Vilenkin metric in spherical coordinates (t,r,theta,phi).
     ...
     \f[ \mathbf{e}_{(0)} = \frac{1}{c}\partial_t,\quad \mathbf{e}_{(1)}=\partial_r,\quad
 \mathbf{e}_{(2)}=\frac{1}{kr}\partial_{\vartheta},\quad \mathbf{e}_{(3)} =
 \frac{1}{kr\sin\vartheta}\partial_{\varphi}.\f]

     Detailed discussions about the BarriolaVilenkin metric can be found in <br><br>
     Manuel Barriola and Alexander Vilenkin<br><b>"Gravitational Field of a Global Monopole"</b><br>Physical Review
 Letters <b>63</b>, 341--343 (1989).
